...
public class AgencyTest {
    ...
    public void payInvoice_create() {
        ...
        this.agency.payInvoice(LocalDate.of(2019, 3, 12));
...
//        assertEquals("Incorrect count", expectedCount, actualCount);
    ...
    @Test
    public void throwInvoiceInPeriod_create() {
        Invoice inv1 = new Invoice("1",
                "HRS",
                125D, Department.INCOMES,
                LocalDate.of(2018, 2, 12),
        ...
        Iterable<Invoice> invoices = this.agency.throwInvoiceInPeriod(LocalDate.of(2019, 2, 11), LocalDate.of(2019, 3, 13));
...
//        assertEquals("Incorrect count", expectedCount, actualCount);
    ...
    @Test
    public void extendDeadline_create() {
        Invoice inv1 = new Invoice("1",
                "HRS",
                125D, Department.INCOMES,
                LocalDate.of(2018, 2, 12),
        ...
        this.agency.create(inv2);
         ...
         this.agency.extendDeadline(LocalDate.of(2019, 3, 12), 5);
